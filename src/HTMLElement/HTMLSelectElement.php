...
trait HTMLSelectElement {
	...
	protected function __prop_get_length():int {
		$this->checkElementType(ElementType::HTMLSelectElement, ElementType::HTMLFormElement);
	...
	protected function __prop_set_selectedIndex(int $value):void {
		$this->checkElementType(ElementType::HTMLSelectElement, ElementType::HTMLMediaElement);
